...
<div class="container-fluid h-100">
    ...
    <div class="row justify-content-center align-items-center">
        ...
        &nbsp;
        <div>
        <form  action='/templates/admin/director/addDirector.php' method='post'>
            <button class="btn btn-success" type="submit" name="addDirector"
                    value="Добавить">
                Добавить
            </button>
        </form>
                    ...
                    foreach ($directors as $director): ?>
                        <tr>
                            ...
                            <td><a class="btn btn-warning"
                                   href="/templates/admin/director/editDirector.php?directorId=<?= $director->directorId ?>"
                                   role="button">Редактировать</a>
                            </td>
                            <td><a class="btn btn-danger"
                                   href="/templates/admin/director/deleteDirector.php?deleteDirectorId=<?= $director->directorId ?>">Удалить</a>
                            </td>
                            <td>
                                <form action='/templates/admin/director/addDirector.php' method='post'>
                                    <button class="btn btn-success" type="submit" name="addDirector"
