    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/templates/admin/movie/movies.php">Фильмы<span
                            class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/templates/admin/director/director.php">Режиссёры</a>
            </li>
        </ul>
        <ul class="navbar-nav">
            ...
            <?php
                ...
                <a href="/templates/logout.php" class="btn btn-danger">Выход</a>
                </li>
            <?php
            endif; ?>
        </ul>
