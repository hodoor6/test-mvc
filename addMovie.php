                            ...
                            <form action="model/movies.php" METHOD="POST">
                                ...
                                foreach (
                                    ...
                                    if ($movie->movieId ==  $_GET['movieId']) : ?>
                                        ...
                                        <div class="form-group">
                                            <label for="inputMovie">Дата выхода</label>
                                            <input type="date" class="form-control" required="required" minlength="10"
                                ...
                                <div class="form-row text-center">
                                    <div class="col-12">
                                        <button type="submit" name="updateMovie" value="Обновить"
